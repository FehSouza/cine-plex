import { MOCK_GET_PERSON, MOCK_GET_SOCIAL_MEDIA, MOCK_GET_WITHOUT_SOCIAL_MEDIA } from '@/mocks'
...
describe('Biography', () => {
  ...
  it('deve renderizar o componente Biography sem o social media', () => {
    render(<Biography person={MOCK_GET_PERSON} quantCredits={2} socialMedia={MOCK_GET_WITHOUT_SOCIAL_MEDIA} />)
  ...
  it('deve renderizar o componente Biography com o knownFor', () => {
    const { rerender } = render(<Biography person={MOCK_GET_PERSON} quantCredits={2} socialMedia={MOCK_GET_SOCIAL_MEDIA} />)
  ...
  it('deve renderizar o componente Biography com o gender', () => {
    ...
    // @ts-ignore
    rerender(<Biography person={person1} quantCredits={2} socialMedia={MOCK_GET_SOCIAL_MEDIA} />)
    expect(screen.getByTestId('biography-gender')).toBeVisible()
  ...
  it('deve renderizar o componente Biography sem o deathday', () => {
    ...
    // @ts-ignore
    rerender(<Biography person={person4} quantCredits={2} socialMedia={MOCK_GET_SOCIAL_MEDIA} />)
    expect(() => screen.getByTestId('biography-deathday')).toThrow('Unable to find an element')
  })
  ...
  it('deve renderizar o componente Biography com o alsoKnown', () => {
    ...
    render(<Biography person={person1} quantCredits={2} socialMedia={MOCK_GET_SOCIAL_MEDIA} />)
